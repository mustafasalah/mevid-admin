    ...
    return (
        <section className="widget list" id="top-authors">
            <header>
                <h3>
                    <span>
                        <i className="fas fa-crown"></i> {text("top_authors")}
                    </span>
                </h3>
                <select
                    ...
                    value={period}
                >
                    <option value={WEEK_PERIOD}>{text("this_week")}</option>
                    <option value={MONTH_PERIOD}>{text("this_month")}</option>
                    <option value={ALL_TIME_PERIOD}>{text("all_time")}</option>
                </select>
            </header>
